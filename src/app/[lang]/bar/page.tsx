...
export default async function BarPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <>
      <PageHero kicker={dict.bar.kicker} title={dict.bar.title} intro={dict.bar.intro} titleClassName="font-logo-title text-momo-orange" />
      ...
      <section className="pb-16"><Container><div className="mx-auto max-w-2xl"><OpeningHours locale={lang as Locale} /></div></Container></section>
