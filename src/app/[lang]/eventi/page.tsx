...
export default async function PromotionsPage({params}:{params:Promise<{lang:string}>}) {
  ...
  const sections=it?[
    ...
    {title:"2026 Special",icon:BadgePercent,items:["Are you a Mendrisiotto resident? You always receive 20% off!","FoxTown customers who show a same-day receipt at the park entrance receive 20% off admission.","After a family meal at Old Wild West, use the 20% admission voucher offered by our partners for every participant."]},
