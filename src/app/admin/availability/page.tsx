  ...
  return (
    <div className="min-h-screen bg-momo-cream pb-24">
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <section id="calendario" className="scroll-mt-8">
          ...
          <div className="mt-5 grid gap-2 rounded-2xl bg-momo-green-neon/15 p-4 text-sm sm:grid-cols-2">
            ...
            <p><b>Giorno chiuso:</b> lunedì, escluso automaticamente</p>
            {siteConfig.openingHours.map(row=><p key={row.day.it}><b>{row.day.it}:</b> {row.hours}</p>)}
          </div>
        </section>
        ...
        <section className="mt-8 rounded-2xl border border-black/10 bg-white p-6">
          ...
          >
            <Field label="Data">
              <input type="date" name="date" min={partyConfig.bookingStartDate} required className="momo-input" />
            </Field>
        ...
        <section className="mt-6 rounded-2xl border border-black/10 bg-white p-6">
          ...
          >
            <Field label="Dal">
              <input type="date" name="start_date" min={partyConfig.bookingStartDate} required className="momo-input" />
            </Field>
            <Field label="Al">
              <input type="date" name="end_date" min={partyConfig.bookingStartDate} required className="momo-input" />
            </Field>
            <Field label="Dalle (opz.)">
              <input type="time" name="start_time" className="momo-input" />
            </Field>
          ...
          <p className="mt-2 text-xs text-momo-black/50">
            Le date già esistenti non vengono sovrascritte. Il lunedì viene sempre saltato perché il parco è chiuso.
          </p>
        </section>
