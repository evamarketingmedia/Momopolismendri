  ...
  return (
    <footer className="border-t-4 border-momo-green-neon bg-white text-momo-black/75">
      ...
      <div className="border-t border-momo-orange/30 bg-momo-orange/10 px-4 py-5 text-center text-xs text-momo-black/55 sm:px-6">
        © 2026 Momopolis · <Link href={`/${locale}/note-legali#privacy`}>Privacy Policy</Link> · <Link href={`/${locale}/note-legali#cookie`}>Cookie Policy</Link> · <Link href={`/${locale}/note-legali`}>{locale === "it" ? "Note legali" : "Legal notice"}</Link>
      </div>
    </footer>
  );
}
